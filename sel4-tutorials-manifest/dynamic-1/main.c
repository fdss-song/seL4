...
int main(void) {
    ...
    */
    ...
    error = vka_alloc_tcb(&vka, &tcb_object);   // TODO error
   ...
   /* TASK 9: initialise the new TCB */
    ...
    NAME_THREAD(tcb_object.cptr, "new dynamic-1");
     ...
     * @return 0 on success
     */
    error = seL4_TCB_WriteRegisters(tcb_object.cptr, seL4_True, 1, 2, &regs);
