...
int main(int c, char* arbv[]) {
    ...
    //TODO fix the parameters in this invocation
    result = seL4_TCB_Configure(tcb_cap_slot, seL4_CapNull, root_cnode, seL4_CapNull, root_vspace, 0, buf2_frame, buf2_frame_cap);
...
/*
    ...
    error = seL4_TCB_WriteRegisters(tcb_cap_slot, 0, 0, 3, &regs);
*/
    sel4utils_arch_init_local_context((void *)new_thread, 
                                    (void *)*new_new_thread, (void *)&tcb_untyped, (void *)3,
